...
# ---- Colors (direction) -
# =========================
# Orden de la leyenda consistente con map_direction_label
DIR_ORDER = [
    "Negative",
    "Mostly negative",
    "Inconclusive",
...
# Paleta de colores: de rojos (Negative) a verdes (Positive)
DIR_COLORS = {
    "Negative": "#d73027",          # rojo intenso
    "Mostly negative": "#fc8d59",   # naranja
    "Inconclusive": "#bdbdbd",      # gris neutro
    "Mostly positive": "#91cf60",   # verde claro
    "Positive": "#1a9850",          # verde intenso
    "N/A": "#e0e0e0"                # gris claro para N/A
}
...
fig.update_layout(
    ...
    legend_title_text="Direction of Evidence (–1 → +1)",
...
app.layout = html.Div([
    ...
    html.P("The Strength of Evidence is defined on a scale from 0.5 (very low) to 3 (high). "
           "The Direction of Effect is classified as Positive (+1), Inconclusive/Mixed (0), or Negative (–1). "
           "Average values can be viewed by clicking on each bubble. Bubble size shows the number of articles. "
           "Color encodes the direction of evidence."),
